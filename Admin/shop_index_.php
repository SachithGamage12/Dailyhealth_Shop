...
<center><i class="fa-solid fa-right-to-bracket" style="color: red !important; <!-- Force black -->
;"></i><p style="color: red !important; <!-- Force black -->
;">Login</p></center>            </a>
        </div>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../login.php">Day's Thought</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../login.php">Health Champs</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../login.php">Health Talks</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../login.php">Downloads</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../login.php">Events</a>
            </li>
...
<div class="products-container">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<button class="cartButton" onclick="addToCart(' . $row['id'] . ', event)"><i class="fas fa-cart-plus"></i> Buy Now</button>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
        }
